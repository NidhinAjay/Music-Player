                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          _position.toString().split(".")[0],style: TextStyle(color: Colors.white70),
                        ),
                        Text(
                          _duration.toString().split(".")[0],style: TextStyle(color: Colors.white70),
                        )
                      ],
                    ),
                    const SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          icon: const Icon(color: Colors.white70,
                            Icons.skip_previous,
                            size: 24.0,
                          ),
                        ),
